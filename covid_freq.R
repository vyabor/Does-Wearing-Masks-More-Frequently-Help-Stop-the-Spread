...
abline(nev)
text(0.09,10000,labels='y = 2394.653 + 32555.439*x',cex = 0.8)
...
abline(rar)
text(0.08,10000,labels='y = 2591 + 28072*x',cex = 0.8)
...
abline(som)
text(0.08,10000,labels='y = 1268.9 + 31104.7*x',cex = 0.8)
...
abline(freq2)
text(0.16,9500,labels='y = -758.4 + 27572.9*x',cex=0.8)
...
abline(alw)
text(0.69,10000,labels='y = 9324.9 - 8490.1*x',cex=0.8)
